...
EXTRACTION_SYSTEM_PROMPT = (
    ...
    "Service-only unless the same fact establishes supply or purchase. Delivery, unloading, "
    "payment, warranty, validity, availability, and exclusions are annotations rather than "
    "Service links unless independently purchased or completed as substantive work. "
    ...
    "dimensions, grade, brand, and model; normalize punctuation; omit transaction or lifecycle "
    "qualifiers such as completed or final; keep the exact supporting wording in "
    "observed_name_text. "
    ...
    "never supplies source evidence. Return the exact supplied active record_id or null. "
