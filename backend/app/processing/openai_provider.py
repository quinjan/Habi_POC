...
EXTRACTION_SYSTEM_PROMPT = (
    ...
    "final/as-used delivery is an independent Delivery Service Purchase Line; include the "
    "clearly known delivered subject in its normalized standalone Service name. Included or "
    ...
    "quantity expresses multiplicity. When package, bundle, or lot describes combined "
    "commercial pricing, exclude that commercial package wording from the Material name. "
    "Preserve packaged or package only when clearly part of the technical product type, such "
    "as a packaged rooftop unit. Name a standalone Service as the worked-on subject "
